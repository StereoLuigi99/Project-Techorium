document.addEventListener("DOMContentLoaded", async function (event) {
  const replacements = [
    ...
    {
      selector: ".node--id58 .xfa-nit-node-icon .fa-apple",
      src: "icons/macos/sonoma/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id60 .xfa-nit-node-icon .fa-apple",
      src: "icons/macos/ventura/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id292 .xfa-nit-node-icon .fa-apple",
      src: "icons/macos/monterey/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id293 .xfa-nit-node-icon .fa-apple",
      src: "icons/macos/big-sur/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id59 .xfa-nit-node-icon .fa-spinner",
      src: "icons/macos/opencore/full.png",
      width: 34,
      height: 34,
    },
    ...
    {
      selector: ".node--id192 .xfa-nit-node-icon .fa-paw",
      src: "icons/linux/pardus/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id193 .xfa-nit-node-icon .fa-linux",
      src: "icons/linux/kali-linux/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id194 .xfa-nit-node-icon .fa-ubuntu",
      src: "icons/linux/ubuntu/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id195 .xfa-nit-node-icon .fa-linux",
      src: "icons/linux/linux-mint/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id196 .xfa-nit-node-icon .fa-parking",
      src: "icons/linux/pop-os/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id197 .xfa-nit-node-icon .fa-linux",
      src: "icons/linux/elementary-os/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id198 .xfa-nit-node-icon .fa-redhat",
      src: "icons/linux/redhat/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id199 .xfa-nit-node-icon .fa-fedora",
      src: "icons/linux/fedora/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id200 .xfa-nit-node-icon .fa-linux",
      src: "icons/linux/arch/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id201 .xfa-nit-node-icon .fa-linux",
      src: "icons/linux/manjaro/full.png",
      width: 34,
      height: 34,
    },
    {
      selector: ".node--id202 .xfa-nit-node-icon .fa-linux",
      src: "icons/linux/gentoo/full.png",
      width: 34,
      height: 34,
    },
  ];
  const result = await browser.storage.local.get("changeIcons");
    ...
    if (Array.isArray(replacements) && replacements.length > 0) {
      replacements.forEach(item => {
        ...
        if (oldElement) {
          ...
          newElement.src = browser.runtime.getURL(item.src);
