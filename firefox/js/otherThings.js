document.addEventListener("DOMContentLoaded", async function (event) {
  ...
  browser.storage.local.get(["mBgIMG"]).then((s) => {
  ...
  mainBgButton.addEventListener('click', function() {
    var mainBgLink = prompt("Lütfen istediğiniz arka planın bağlantısını girin.\nBu alanı boş bırakırsanız var olan arka plan kaldırılır.");
      if (mainBgLink != null && mainBgLink != undefined) {
        ...
        browser.storage.local.set({"mBgIMG": mainBgLink }).then(() => {
  ...
  if (document.querySelector('a[href="/sosyal/hesap/banner"]') != null) {
    browser.storage.local.get(["pfBgIMG"]).then((s) => {
    ...
    bgButton.addEventListener('click', function() {
      ...
      if (bgLink != null && bgLink != undefined) {
        ...
        browser.storage.local.set({"pfBgIMG": bgLink }).then(() => {
  ...
  function checkDateL(x) {
    if (x == "25 Aralık") {
      var checkDateResult = `.p-header-logo.p-header-logo--image > a[href="/sosyal/"] > picture > img {
                content: url(${browser.runtime.getURL("custom-logos/christmas.png")}) !important;
      ...
      var checkDateResult = `.p-header-logo.p-header-logo--image > a[href="/sosyal/"] > picture > img {
                content: url(${browser.runtime.getURL("custom-logos/newyear.png")}) !important;
                width: 341px !important;
                height: 59px !important;
                aspect-ratio: auto 270 / 50 !important;
            }
      ...
      var checkDateResult = `.p-header-logo.p-header-logo--image > a[href="/sosyal/"] > picture > img {
                content: url(${browser.runtime.getURL("custom-logos/6subat.png")}) !important;
      ...
      var checkDateResult = `.p-header-logo.p-header-logo--image > a[href="/sosyal/"] > picture > img {
                content: url(${browser.runtime.getURL("custom-logos/23nisan.png")}) !important;
                width: 310px !important;
                height: 59px !important;
                aspect-ratio: auto 270 / 50 !important;
            }
      ...
      var checkDateResult = `.p-header-logo.p-header-logo--image > a[href="/sosyal/"] > picture > img {
                content: url(${browser.runtime.getURL("custom-logos/19mayis.png")}) !important;
                width: 310px !important;
                height: 59px !important;
                aspect-ratio: auto 270 / 50 !important;
            }
      ...
      var checkDateResult = `.p-header-logo.p-header-logo--image > a[href="/sosyal/"] > picture > img {
                content: url(${browser.runtime.getURL("custom-logos/30agustos.png")}) !important;
                width: 310px !important;
                height: 59px !important;
                aspect-ratio: auto 270 / 50 !important;
            }
      ...
      var checkDateResult = `.p-header-logo.p-header-logo--image > a[href="/sosyal/"] > picture > img {
                content: url(${browser.runtime.getURL("custom-logos/29ekim.png")}) !important;
                width: 310px !important;
                height: 59px !important;
                aspect-ratio: auto 270 / 50 !important;
            }
      ...
      var checkDateResult = `.p-header-logo.p-header-logo--image > a[href="/sosyal/"] > picture > img {
                content: url(${browser.runtime.getURL("custom-logos/10kasim.png")}) !important;
                width: 310px !important;
                height: 59px !important;
                aspect-ratio: auto 270 / 50 !important;
            }
      ...
      var checkDateResult = `.p-header-logo.p-header-logo--image > a[href="/sosyal/"] > picture > img {
                content: url(${browser.runtime.getURL("techolay-dijitalfikir.png")}) !important;
...
`,
  ...
  browser.storage.local.get(settings.map(s => s.key)).then(local => {
  ...
  async function addEmojiPickerAndEmojis() {
    const response = await fetch(browser.runtime.getURL("emoji/chooser.html"));
