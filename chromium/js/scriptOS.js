...
document.addEventListener("DOMContentLoaded", function(event) {
    {
        if ((window.location.href == "https://techolay.net/sosyal/") || (window.location.href == "https://techolay.net/sosyal/kategori/isletim-sistemleri.51/"))
        {
            ...
            newWin11.src = chrome.runtime.getURL('icons/windows/win11/full.png');
            ...
            newWin10.src = chrome.runtime.getURL('icons/windows/win10/full.png');
            ...
            newWin8.src = chrome.runtime.getURL('icons/windows/win8/full.png');
            ...
            newWin7.src = chrome.runtime.getURL('icons/windows/win7/full.png');
            ...
            newWinXP.src = chrome.runtime.getURL('icons/windows/win-other/full.png');
            ...
            newSonomaS.src = chrome.runtime.getURL('icons/macos/sonoma/full.png');
            ...
            newVenturaS.src = chrome.runtime.getURL('icons/macos/ventura/full.png');
            ...
            newOpenCoreS.src = chrome.runtime.getURL('icons/macos/opencore/full.png');
            ...
            newMacOSCatS.src = chrome.runtime.getURL('icons/macos/macos-cat/full.png');
            ...
            newLinuxCatS.src = chrome.runtime.getURL('icons/linux/linux-cat/full.png');
            ...
            newDebianS.src = chrome.runtime.getURL('icons/linux/debian/full.png');
            ...
            newPardusS.src = chrome.runtime.getURL('icons/linux/pardus/full.png');
            ...
            newKaliS.src = chrome.runtime.getURL('icons/linux/kali-linux/full.png');
            ...
            newUbuntuS.src = chrome.runtime.getURL('icons/linux/ubuntu/full.png');
            ...
            newLinuxMintS.src = chrome.runtime.getURL('icons/linux/linux-mint/full.png');
            ...
            newPopOS_S.src = chrome.runtime.getURL('icons/linux/pop-os/full.png');
            ...
            newElementaryOS_S.src = chrome.runtime.getURL('icons/linux/elementary-os/full.png');
            ...
            newRedHatS.src = chrome.runtime.getURL('icons/linux/redhat/full.png');
            ...
            newFedoraS.src = chrome.runtime.getURL('icons/linux/fedora/full.png');
            ...
            newArchLinuxS.src = chrome.runtime.getURL('icons/linux/arch/full.png');
            ...
            newManjaroLinuxS.src = chrome.runtime.getURL('icons/linux/manjaro/full.png');
            ...
            newGentooS.src = chrome.runtime.getURL('icons/linux/gentoo/full.png');
            ...
            newAmogOS_.src = chrome.runtime.getURL("icons/amogos-full.png");
        ...
        else if (window.location.href.indexOf("https://techolay.net/sosyal/bolum/macos.57/") > -1)
        {
            ...
            newSonoma.src = chrome.runtime.getURL('icons/macos/sonoma/full.png');
            ...
            newVentura.src = chrome.runtime.getURL('icons/macos/ventura/full.png');
            ...
            newOpenCore.src = chrome.runtime.getURL('icons/macos/opencore/full.png');
        ...
        else if (window.location.href.indexOf("https://techolay.net/sosyal/bolum/gnu-linux.61/") > -1)
        {
            ...
            newDebian.src = chrome.runtime.getURL("icons/linux/debian/full.png");
            ...
            newPardus.src = chrome.runtime.getURL("icons/linux/pardus/full.png");
            ...
            newKaliLinux.src = chrome.runtime.getURL("icons/linux/kali-linux/full.png");
            ...
            newUbuntu.src = chrome.runtime.getURL("icons/linux/ubuntu/full.png");
            ...
            newLinuxMint.src = chrome.runtime.getURL("icons/linux/linux-mint/full.png");
            ...
            newPopOS_.src = chrome.runtime.getURL("icons/linux/pop-os/full.png");
            ...
            newElementaryOS_.src = chrome.runtime.getURL("icons/linux/elementary-os/full.png");
            ...
            newRedHat.src = chrome.runtime.getURL("icons/linux/redhat/full.png");
            ...
            newFedora.src = chrome.runtime.getURL("icons/linux/fedora/full.png");
            ...
            newArchLinux.src = chrome.runtime.getURL("icons/linux/arch/full.png");
            ...
            newManjaroLinux.src = chrome.runtime.getURL("icons/linux/manjaro/full.png");
            ...
            newGentoo.src = chrome.runtime.getURL("icons/linux/gentoo/full.png");
